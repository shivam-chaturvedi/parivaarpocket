...
Common Types of Loans
  oo   Education loans  -  for studies and skill development
  oo   Personal loans  -  high interest, flexible use
  oo   Microloans  -  small loans, often used by low-income households
Key loan terms:
  oo   Principal: Amount borrowed
  oo   Interest: Cost of borrowing
  oo   EMI (Equated Monthly Instalment): Fixed monthly repayment
...
Good borrowing practices include:
  oo   Borrowing only for productive purposes (education, business)
  oo   Comparing interest rates before borrowing
  oo   Ensuring EMIs fit within the household budget
Bad borrowing leads to:
  oo   Missed repayments
  oo   Penalties and stress
  oo   Reduced future borrowing ability
...
Key concepts and examples:
  oo   Household Income and Expenses: Together, a family has income (salaries, farm income, business) and expenses (food, rent, school fees, healthcare). By learning budgeting and saving, you can suggest how to reduce unnecessary costs. For example, comparing electricity providers, or deciding to cook at home rather than eat outside can save money.
  oo   Sharing Responsibilities: If you have earned or saved money, talk with family about using it for important needs. For example, Priya pooled her savings with her mother to buy ingredients in bulk, which reduced the grocery bill by 10%.
  oo   Decision-Making: Families can make decisions like "we will save ₹500 this month for a new water pump". You can help by tracking this savings in a notebook. Participation teaches financial planning.
  oo   Emergency Planning: Families sometimes face crises (illness, crop failure). Discussing an emergency fund or how to cut costs helps everyone. For example, if a family sets aside a small fund each month for emergencies, they won''t have to take high-interest loans later.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Why is it good for a family to have an emergency fund?', ARRAY['For holidays', 'To avoid borrowing in a crisis', 'To lend to friends', 'For no reason.'], 1, 1 FROM public.quizzes WHERE title = 'M11: Financial Goal Setting Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
Key concepts and examples:
  oo   Education and Career Plans: Decide what you want to study or do after school. Save or seek help (scholarships) to reach those goals. Example: Kiran wants to attend college in another city; knowing it costs ₹50,000 total, her family started saving a small amount each month early.
  oo   Inflation and Costs: Prices tend to rise over time (inflation). What costs ₹100 today might cost ₹110 next year. When planning future expenses (like college fees, marriage expenses), remember this. It means saving early is even more important.
  oo   Continuing to Learn: Stay informed about money (books, trustworthy websites) and adjust your plans as needed. The world of work changes (new jobs in technology, etc.). Be flexible and willing to learn new skills.
  oo   Supporting Economic Security: Your personal planning contributes to your family''s security. If you get a good job or manage money well, you break cycles of debt and help the next generation.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'What does personal finance primarily involve?', ARRAY['Learning history', 'Managing money (income, spending, saving)', 'Physical exercise', 'Cooking.'], 1, 1 FROM public.quizzes WHERE title = 'M1: Introduction to Personal Finance Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Give one example of a need and one example of a want for a student.', ARRAY['Need: Video games, Want: School books', 'Need: School uniform, Want: New headphones', 'Need: Movie tickets, Want: Lunch', 'Need: Chocolates, Want: Water'], 1, 1 FROM public.quizzes WHERE title = 'M1: Introduction to Personal Finance Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
-- Module M2
INSERT INTO public.lessons (id, title, difficulty, description, progress_percent, quizzes_total)
VALUES (gen_random_uuid(), 'M2: Budgeting Essentials', 'Beginner', 'Managing day-to-day money starts with making a budget, or a simple money plan. Budgeting means writing down how much money you expect (income) and what you need to spend it on. For a student, income might be pocket money or help from family; expenses include food, school supplies, bus fare, and maybe a bit for fun. By planning ahead, you know if your money will last the month.
Key concepts and examples:
  oo   List Income and Expenses: Write down all money you have coming in (e.g., ₹300 monthly pocket money) and all expenses. For example, Rani lists ₹150 for notebooks, ₹50 for phone calls, and ₹100 for other needs. This way she sees her money clearly.
  oo   Track Needs vs Wants: First pay for needs. If you have ₹300, paying ₹150 for notebooks and ₹100 for lunch (₹250 total) covers needs. Then think carefully about wants  -  maybe ₹50 for a movie ticket. Any more spending could hurt savings.
  oo   Balance Your Budget: Ensure you don''t plan to spend more than you have. If expenses exceed income, you must cut back on wants or find more income. For example, if Rani plans to spend ₹350 on everything with only ₹300 income, her budget is unbalanced and she must adjust.
  oo   Use Simple Budget Tools: You can use a notebook or a phone app (many free apps exist) to list and add up numbers. Even a simple table on paper helps. Seeing your budget written down makes money feel real, not just guesses.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Raju has ₹500 for the month. He spends ₹200 on tuition, ₹100 on food, and ₹150 on clothes. How much is left? Is his budget balanced if he wanted to save ₹100?', ARRAY['₹100 left; Yes, it is balanced', '₹50 left; No, it is not balanced', '₹150 left; Yes, it is balanced', '₹50 left; Yes, it is balanced'], 1, 1 FROM public.quizzes WHERE title = 'M2: Budgeting Essentials Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'If you plan to save ₹50 but end up needing ₹50 extra for school fees, what should you do? Give one example of cutting a non-essential expense.', ARRAY['Spend more on entertainment', 'Borrow money without planning', 'Cut a non-essential expense, like eating out or buying snacks', 'Stop budgeting completely'], 2, 1 FROM public.quizzes WHERE title = 'M2: Budgeting Essentials Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Which of these is a good budgeting method?', ARRAY['Spend freely and save whatever is left', 'Decide on savings first, then plan for needs and wants', 'Not keeping track of money', 'Borrow money when needed.'], 1, 1 FROM public.quizzes WHERE title = 'M2: Budgeting Essentials Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
Key concepts and examples:
  oo   Set Clear Goals: Decide why you are saving. Common goals for students: paying exam fees, buying a textbook, or even helping buy medicines. Tara wanted a new backpack costing ₹500; by saving just ₹50 per month, she had the money in 10 months.
  oo   Start Small, Save Regularly: You don''t need a lot to start. Even putting aside ₹20 each week is good practice. Treat saving like a regular expense. For example, if you earn ₹200 from a weekend job, immediately keep ₹50 in a separate place.
  oo   Use a Safe Place: Keep savings where it won''t be spent easily. A piggy bank or an old jar at home works. A better way is a bank account (see Module 4)  -  banks often give interest on your savings, so your money grows a little. For instance, banks pay some extra money (interest) on your savings balance.
  oo   Emergency Fund: Besides goals, keep a small emergency fund. This money is only used for urgent needs like a medical expense or sudden travel. It prevents you or your family from borrowing at high interest.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'If you save ₹30 each week, how much will you save in 10 weeks? Is this enough for a ₹300 school bag?', ARRAY['₹300; Yes, it is enough', '₹200; No, it is not enough', '₹250; No, it is not enough', '₹300; No, it is not enough'], 0, 1 FROM public.quizzes WHERE title = 'M3: Saving and Financial Goals Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Choose the best way to increase your savings:', ARRAY['Spend all your money now and hope to save later', 'Save a fixed part of any money you get', 'Only save if you have leftovers', 'None of these.'], 1, 1 FROM public.quizzes WHERE title = 'M3: Saving and Financial Goals Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
-- Module M4
INSERT INTO public.lessons (id, title, difficulty, description, progress_percent, quizzes_total)
VALUES (gen_random_uuid(), 'M4: Understanding Credit', 'Beginner', 'Sometimes people need to borrow money (credit), for example, for education or emergencies. However, borrowing means debt  -  you must pay back more than you took because of interest. Debt can be useful (like a small emergency loan from a bank with low interest), but it can also be dangerous if misused (like expensive high-interest loans).
Key concepts and examples:
  oo   Borrowing Smartly: Only borrow for important reasons (college fees, health emergency). If you borrow ₹1000 at 10% interest, you must repay ₹1100. High-interest loans (like from some moneylenders) can trap people. For instance, if a shop owner loans money at 20% interest, you owe ₹1200 on a ₹1000 loan after a year. This can be hard to repay if income is low.
  oo   Credit Cards and Small Loans: Adults sometimes use credit cards or small loans (EMI) for purchases. These should be used carefully  -  always plan how to repay them on time. If not, penalties and extra charges add up.
  oo   Avoiding Bad Debt: Beware of schemes promising easy money, like pyramid scams or lottery frauds  -  these are common traps. Also, avoid spending borrowed money on wants; it should go to needs or investment (education, business).
  oo   Reaching Financial Security: Good credit (repaying loans on time) helps secure your family''s future. It can mean better loan terms later for things like a family business or home.
Financial Tip: Never borrow money from unreliable sources. If your family needs a loan, check if your bank offers small loans at reasonable interest, or look for government schemes. Always ask: "Can I really repay this?" before borrowing.', 0, 1);
INSERT INTO public.quizzes (lesson_id, title, difficulty, total_marks, passing_marks)
...
Key concepts and examples:
  oo   Types of Accounts: The most common is a savings account. You deposit money and can withdraw it when needed. Some banks also offer special student accounts or no-frills accounts (like Jan-Dhan). Example: Anu opened a Jan-Dhan account with ₹100 deposit; later, her friends transfer her earned money to this account via a phone app.
  oo   Debit Card and Mobile Banking: Banks often give a debit card and let you do mobile or online banking. With these, you can pay bills or buy online without cash. Always keep your card/PIN secret. For example, Varun pays his school fees online through mobile banking, which is safer than carrying cash.
  oo   Interest on Savings: Banks reward you for keeping money by adding a small percentage as interest. For example, if the bank gives 4% per year, ₹100 saved becomes ₹104 in a year. While small, this means your money grows without extra effort.
  oo   Avoid Risk: Unlike hiding cash at home (which can be lost or stolen), a bank keeps money secure. Also, if you must borrow later, a good banking history helps you qualify for small loans at lower interest rates (see Module 5).
...
Expenses fall into two main categories:
  1.   Fixed expenses  -  costs that remain mostly the same each month (school fees, rent, electricity minimum charges).
  2.   Variable expenses  -  costs that change depending on usage or choices (food, transport, phone data, snacks).
A common problem is leakage spending  --  small daily expenses that seem insignificant but add up over time. For example, spending ₹20 daily on snacks results in ₹600 per month, which could otherwise cover school materials or savings.
Effective expense management involves:
  oo   Recording every expense, even small ones.
  oo   Comparing expenses to income to ensure spending does not exceed earnings.
  oo   Identifying unnecessary spending and redirecting money to savings or essential needs.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Explain the difference between fixed and variable expenses using one household example of each.', ARRAY['Fixed: Snacks, Variable: Rent', 'Fixed: Electricity bill, Variable: School fees', 'Fixed: House rent, Variable: Monthly groceries', 'Fixed: Movie tickets, Variable: Mobile phone'], 2, 1 FROM public.quizzes WHERE title = 'M6: Managing Expenses Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Identify two examples of leakage spending common among students.', ARRAY['Paying school fees and buying textbooks', 'Saving money and investing', 'Frequent snacks and unnecessary mobile data packs', 'Paying rent and electricity bills'], 2, 1 FROM public.quizzes WHERE title = 'M6: Managing Expenses Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
Emergency funds protect families from:
  oo   Borrowing from moneylenders
  oo   Selling essential assets
  oo   Missing school fees or rent payments
...
Emergency funds should be:
  oo   Liquid: Easily accessible (bank savings account)
  oo   Separate: Not mixed with daily spending money
  oo   Safe: Not invested in risky assets like stocks
...
ParivaarPocket encourages emergency saving by:
  oo   Setting savings goals
  oo   Locking funds digitally
  oo   Rewarding consistency with points
Financial Tip
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'Give two examples of situations where an emergency fund would be used.', ARRAY['Buying new clothes and gadgets', 'Paying school fees late and shopping online', 'Medical emergencies and urgent house repairs', 'Vacations and entertainment'], 2, 1 FROM public.quizzes WHERE title = 'M7: Emergency Funds Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
Key concepts and examples:
  oo   Safe Investments: The simplest is a Fixed Deposit (FD) at a bank. You deposit money for a fixed time (say 1 year) and the bank pays a bit more interest (often higher than a savings account). For instance, depositing ₹1000 in a 1-year FD at 6% returns ₹1060 after a year.
  oo   Caution with Risk: Some ask you to invest in stocks or schemes promising fast money. These are risky. Always ask: "Do I really understand this?" For students, it''s safer to stick to known methods (bank accounts, gold, government bonds if any) until you learn more.
  oo   Invest in Yourself: The best investment is often education. Spending money on books or learning a new skill can pay off later with higher earning jobs. For example, taking a short computer course might cost ₹2000 but could help you earn more in tuitions or jobs later.
  oo   Avoid Hasty Decisions: Never put all your money into one thing. Start small. If a neighbor suggests you "double your money in one week" scheme, it''s probably a scam.
...
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
SELECT id, 'True or False: Spending money on books and education can be considered an investment.', ARRAY['True', 'False'], 0, 1 FROM public.quizzes WHERE title = 'M8: Investments Overview Quiz';
INSERT INTO public.quiz_questions (quiz_id, question, options, correct_option, points)
...
-- Module M9
INSERT INTO public.lessons (id, title, difficulty, description, progress_percent, quizzes_total)
VALUES (gen_random_uuid(), 'M9: Stocks and Bonds', 'Beginner', 'Stocks and bonds are investment tools that allow individuals to grow their money over time, but they work very differently.
Stocks
Buying a stock means owning a small part of a company. If the company grows and becomes more profitable, the value of the stock increases. However, if the company performs poorly, the value can fall.
  oo   Higher risk
  oo   Higher potential returns
  oo   Prices change daily
Bonds
Bonds are loans given to governments or companies. When you buy a bond, you receive regular interest payments, and your money is returned after a fixed period.
  oo   Lower risk
  oo   Stable returns
  oo   Suitable for cautious investors
For underprivileged families, capital protection is important. This means not risking money needed for food, rent, or education. Stocks are better for long-term wealth creation, while bonds help preserve money.
A balanced investor uses both:
  oo   Stocks for growth
  oo   Bonds for stability
